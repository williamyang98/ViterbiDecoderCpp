...
public:
    ...
    template <typename ... U>
    ViterbiDecoder_SSE_u16(U&& ... args): Base(std::forward<U>(args)...) {
...
private:
    void bfly(const int16_t* symbols, decision_bits_t* decision, uint16_t* old_metrics, uint16_t* new_metrics) {
